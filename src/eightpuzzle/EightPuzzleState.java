...
public class EightPuzzleState extends State implements Cloneable {
     ...
     * Can be used as a consistent, and therefore also admissible heuristic.
     * @param finalState The state that represents the goal state; used for compare the tiles.
     */
    ...
    /**
     * Computes the sum of the manhattan distances of the tiles out of place to their correct slots, ignoring the blank (0) tile. <p/>
     * Can be used as a consistent, and therefore also admissible heuristic.
     * @param finalState The state that represents the goal state; used for compare the tiles.
     */
